...
//         }
//         // 새로운 스트림이 생성되었을 때 해당 스트림이 비디오를 가지고 있지 않으면 subscriberList배열에 추가하여
//         // 다시 Subscribers state에 담아서 업데이트
//       });
...
//           <div>
//             <h2>Main Stream</h2>
//             <div ref={(ref) => ref && mainStreamManager.addVideoElement(ref)} />
//           </div>
//         )}
...
//             <div ref={(ref) => ref && subscriber.addVideoElement(ref)} />
//           </div>
//         ))}
//       </div>
//     </>
